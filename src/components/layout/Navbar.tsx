        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-3">
            ...
            <div className="flex items-center space-x-3 shrink-0">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-orange-600 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-500/20 ring-2 ring-orange-400/30">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="hidden xs:inline-block text-[10px] uppercase font-semibold px-2 py-0.5 rounded-full bg-orange-500/20 text-orange-400 border border-orange-500/30">
                    Apartment Pro
                  </span>
                </div>
                <button
                  ...
                  className="text-xs text-slate-400 hover:text-orange-300 flex items-center gap-1.5 truncate max-w-[160px] sm:max-w-xs transition text-left group py-1"
                >
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
              ...
              {isInstallable && !isInstalled && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 bg-slate-800 hover:bg-slate-750 text-orange-400 hover:text-orange-300 border border-orange-500/30 rounded-lg text-xs font-semibold shadow-sm transition active:scale-95 disabled:opacity-50"
                >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white text-xs font-semibold rounded-lg shadow-sm shadow-orange-500/20 transition active:scale-95"
              >
                <Plus className="w-4 h-4" />
                <span className="hidden sm:inline">New Billing Month</span>
                <span className="sm:hidden">New Month</span>
              </button>
